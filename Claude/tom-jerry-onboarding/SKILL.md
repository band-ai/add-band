...
This SKILL.md may itself be loaded from any branch (a feature branch during testing, `main` after merge) — no branch-sniffing is needed because everything the skill references is pinned to `main`.
