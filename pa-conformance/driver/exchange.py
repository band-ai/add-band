...
# would let a run silently lower the conformance bar. The values are the
# exchange's conformance bound itself (~6 agent messages / ~90 s).
...
def marker(run_id: str, *, prefix: str = "PA-MARK") -> str:
